...
export const TERMS_PRIVACY_CONTACT_EMAIL = 'support@superbuild.pro';
export const TERMS_PRIVACY_WEBSITE = 'superbuild.pro';
export const TERMS_PRIVACY_COMPANY = 'SuperBuild.Pro';
export const TERMS_PRIVACY_EFFECTIVE_DATE = 'January 1, 2023';
export const TERMS_PRIVACY_APP_NAME = 'SuperBuild.Pro';
